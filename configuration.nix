...
let
    ...
    colors = {
        ...
        blue = "3E68D7";
        blue_dark = "1E2030";
        blue_dark_muted = "25253A";
        blue_light = "86E1FC";
        blue_light_muted = "89B4FA";
        blue_muted = "444A73";
        green = "71F5B1";
        green_dark_muted = "5F8989";
        grey = "808080";
        grey_blue = "7F85A3";
        grey_dark = "595959";
        grey_light = "F5EFED";
        ...
        red_light = "FC7B7B";
        turquoise = "4FD6BE";
        turquoise_light = "B4F9F8";
        white = "F5F5F5";
        yellow = "FCE656";
        yellow_muted = "FFC777";

        primary_accent = "89B4FA";
        secondary_accent = "71F5B1";
        tertiary_accent = "AF89FA";
    };
in {
    imports = [ 
        ./system/audio.nix
        ...
        (import ./system/starship.nix {inherit colors;})
